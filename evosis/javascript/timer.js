$(document).ready(function() {
	...
	$('.blocEXP').fadeIn('slow', 0);
        
    setTimeout(function() {
        
        $('.blocEXP').fadeOut('fast', 0);
...
jQuery.fn.colourPicker = function (conf) {
	...
	var config = jQuery.extend({
		...
		ico:		'common/images/icones/jquery.colourPicker.gif',				// SRC to colour-picker icon
		title:		'Choix de la couleur',		// Default dialogue title
